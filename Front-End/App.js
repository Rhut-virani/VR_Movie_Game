      ...
      if(moviestate){
        ...
        return (
          ...
          which are the clues and the ans */}
            ...
            <View style={styles.timerpanel}>
              <View style={styles.board}>
                  <Text style={{color: '#000000', alignSelf: 'center', fontSize: 30}}>{this.state.score}</Text>
              </View>                        
            </View> 
      ...
      return(
          <View style={styles.loadingpanel}>      
            ...
            <View style={styles.loadingtextbox}>
              <Text style={styles.loadingtext}>-- Guess the movie Based on Clues Given</Text>
...
const styles = StyleSheet.create({
  ...
  panel:{
    ...
    height: 660,
    // backgroundColor: 'rgba(111, 206, 211, 0.2)',
    flexDirection: 'column',
    alignItems: 'center',
    marginLeft: 10,
    marginRight: 10,
