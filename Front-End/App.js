      ...
      if(moviestate){
        ...
        return (
          ...
          which are the clues and the ans */}
            ...
            <View style={styles.timerpanel}>
              <View style={styles.board}>
                  <Text style={{color: '#fff', alignSelf: 'center', fontSize: 30}}>{this.state.score}</Text>
              </View>                        
            </View> 
          ...
          <View style={styles.loadingpanel}>      
            <View style={styles.loading}>
              <Animated.Image
                ...
                source={{uri: 'https://openclipart.org/image/2400px/svg_to_png/32425/movie-reel.png'}}
              />
            </View>
            <View style={styles.loadingtextbox}>
              <Text style={styles.loadingtext}>Guess the movie based on Clues</Text>
              <Text style={styles.loadingtext}>Look at a button for 3 SEC to click it</Text>
              <Text style={styles.loadingtext}>Right Answer gives 20 :: Wrong cuts 5</Text>
              <Text style={styles.loadingtext}>Player loses if score less than 0</Text>
            </View>
          </View>
        )
      }
