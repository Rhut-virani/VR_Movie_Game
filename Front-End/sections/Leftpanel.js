...
export default class Leftpanel extends React.Component {
	render() {
		...
		let imgurl = moviestate.images.backdrops[0]
			? moviestate.images.backdrops[0].file_path
			: moviestate.images.posters[0].file_path;
						...
						<GazeButton
							...
							render={(remainingTime, isGazed) => (
								<Text style={styles.imgtext}>
									Click for Poster Image (100 points) {"\n"}{" "}
									{parseInt(remainingTime / 1000)} Sec to Click
								</Text>
							)}
						/>
					)}
